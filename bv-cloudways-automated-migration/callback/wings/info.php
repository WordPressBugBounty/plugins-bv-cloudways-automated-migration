...
if (!class_exists('CWSInfoCallback')) :

class CWSInfoCallback extends CWSCallbackBase {
	public $db;
	public $settings;
	public $siteinfo;
	public $bvinfo;
	...
	public function getSystemInfo() {
		$sys_info = array(
			'host' => CWSHelper::getRawParam('SERVER', 'HTTP_HOST'),
			'phpversion' => phpversion(),
			'AF_INET6' => defined('AF_INET6')
		);
		if (array_key_exists('SERVER_ADDR', $_SERVER)) {
			$sys_info['serverip'] = CWSHelper::getRawParam('SERVER', 'SERVER_ADDR');
		}
	...
	public function getHostInfo() {
		...
		if (isset($_SERVER['SERVER_ADDR']) && function_exists('gethostbyaddr')) {
			$host_info['HOST_FROM_IP'] = gethostbyaddr(CWSHelper::getRawParam('SERVER', 'SERVER_ADDR'));
		}
	...
	public function serverConfig() {
		return array(
			'software' => CWSHelper::getRawParam('SERVER', 'SERVER_SOFTWARE'),
